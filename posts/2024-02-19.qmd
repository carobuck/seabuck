...
[Addendum: Another sunset]{.subheaders}

::: {layout="[63,-1,36]"}

![Red sky at night is sailor's delight^[and red sky in morning, sailors take warning]](pics/sunset2.jpg){fig-alt="image of sunset over the ocean, with streaky clouds."}

![\^\^delight](pics/sunset3.jpg){fig-alt="caro with the sunset"}
