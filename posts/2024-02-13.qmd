...
Last day at work today (until the end of March)--a wild feeling to say the least! Projects kept me busy up until the very end, and I'm very grateful to my coworkers who are supportive and helping to pick up some of my regular duties so I can head out to sea. 
...
I also figured out how to get this site to auto-publish to Netlify (via [Github Action](https://quarto.org/docs/publishing/netlify.html#github-action)), which will probably come in very handy when out to sea and wifi is a more limited resource. Side bar for the even bigger nerds--did y'all see the [new Quarto update](https://quarto.org/docs/blog/posts/2024-01-24-1.4-release/)?! The new dashboards feature looks SLICK.
